...
@php
    ...
    $selectedThumb = $imageMedia->firstWhere('id', (int) old('thumbnail_media_id'));
@endphp
...
<x-app-layout>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm font-medium text-[#756b62]">
                    Add YouTube video information, thumbnail and SEO data.
                </p>
            </div>
    ...
    <div
        x-data="{
            ...
            youtubeUrl: @js(old('video_url', '')),
            selectedThumbId: @js(old('thumbnail_media_id')),
    ...
    >
        <form action="{{ route('videos.store') }}" method="POST" class="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
            @csrf
                    ...
                    <div class="mb-6 flex items-center gap-3 border-b border-[#784828]/10 pb-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-[#756b62]">
                                Main YouTube video information.
                            </p>
                        </div>
                    </div>
